...
| 模型版本 | 推理速度 | 模型大小 | 备注 |
|---------|---------|---------|------|
| Faster R-CNN | 待量化评估 | 158 MB | 高精度版本 |
| YOLOv8-Medium | 待量化评估 | 52 MB | 平衡版本 |
| EfficientDet | 待量化评估 | 42 MB | 高效版本 |
| 轻量级版本 | 待量化评估 | 18 MB | 移动端优化 |

> **性能测试说明**：模型推理速度正在不同硬件环境下进行量化评估，包括GPU、CPU和移动设备等多种部署场景。具体测试结果将在完成后更新。
